...
# Locate the Gasp and simulation parameter files.
parameter_file_gasp=$code_dir"/analysis_drivers_gasp/sceptre_function_args.R"
...
# Rscript $code_dir"/simulations/obtain_data_1.R" $offsite_dir $parameter_file_gasp

echo Generate the simulation data.
# Rscript $code_dir"/simulations/fit_model_generate_data_2.R" $offsite_dir $parameter_file_gasp
