...
packages <- c("R.utils", "fst", "sn", "MASS", "VGAM", "tidyverse", "bigstatsr", "monocle", "sceptre")
locs <- c(rep("CRAN", 7), "Bioc", "github")
github_repo <- c(rep(NA, 8), "Timothy-Barry/sceptre_paper")
github_repo_subdir <- c(rep(NA, 8), "sceptre")
