...
sub_dirs <- c(create_parent_directories("data/xie/raw"), create_parent_directories("data/xie/precomp/gRNA"), "data/xie/precomp/gene", "data/xie/processed",
              create_parent_directories("results/xie/sceptre"), "results/xie/negative_binomial", "results/xie/bulk_rna_seq", "figures", create_parent_directories("logs/xie"),
              "data/simulations", "results/simulations", "logs/simulations") %>% unique()
