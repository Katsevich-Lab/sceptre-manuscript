...
packages <- c("Seurat", "R.matlab", "R.utils", "fst", "sn", "MASS", "VGAM", "tidyverse", "bigstatsr", "openxlsx", "rhdf5", "ravel", "sceptre", "katsevich2020")
locs <- c(rep("CRAN", 10), "Bioc", rep("github", 3))
github_repo <- c(rep(NA, 11), "Timothy-Barry/ravel", "Timothy-Barry/sceptre_paper", "Timothy-Barry/sceptre_paper")
